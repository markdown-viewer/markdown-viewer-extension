...
import { BackgroundCacheProxy } from './cache-proxy.js';
 ...
 * @returns {Object} Cache tab manager instance
 */
export function createCacheTabManager({ showMessage, showConfirm }) {
   ...
   * @param {string} primaryText - Primary message text
   * @param {string} detailText - Detail message text
   */
  function updateCacheMessage(primaryText, detailText) {
   ...
   * @param {Array} items - Cache items array
   */
